...
TMR2_INT
    ...
    ; add PHASE_INCR to phase accumulator
    ; phase accumulator might be 16 bits, if the clock can be increased enough (unlikely)
    ; phase incr might also be 16 bits (or less)
    banksel PHASE_INCR
    movfw PHASE_INCR
    addwf PHASE_ACCL, F
